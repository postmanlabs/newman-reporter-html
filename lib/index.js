        ...
        this.exports.push({
            ...
            content: compiler({
                ...
                summary: {
                    ...
                    responseMin: util.prettyms(this.summary.run.timings.responseMin),
                    responseMax: util.prettyms(this.summary.run.timings.responseMax),
                    responseSd: util.prettyms(this.summary.run.timings.responseSd),
